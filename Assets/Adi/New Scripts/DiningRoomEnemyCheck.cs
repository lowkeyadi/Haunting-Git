...
public class DiningRoomEnemyCheck : MonoBehaviour, IWaypointFollower
{
    [Header("Movement")]
    ...
    public DiningRoomFearMeter diningRoomFearMeter;
    ...
    [Header("Scare Pause")]
    public float scaredPauseTime = 1.5f;
    ...
    private IEnumerator ReactToScare()
    {
        ...
        if (diningRoomFearMeter != null)
            diningRoomFearMeter.RegisterScare();
